      ...
      <div className="grid bg-[#FEC901] grid-flow-row grid-cols-1 800px:h-[600px] border border-b pb-5 800px:pb-0 border-black  font-Unbounded  800px:grid-cols-2  ">
        <div className="  flex justify-center w-full items-center  order-1 min-h-[350px] 800px:h-full bg-[#FEC901] ">
            <div className=" bg-[#A7BDFF] shadow-xl py-7 flex flex-col px-9 w-[80%] 400px:w-[70%] 800px:w-[70%] 1200px:w-[60%] 1500px:w-[55%] rounded-lg">
                <p className=" text-[13px] mb-5 1000px:text-[20px]">
                    Contact
                </p>
                <input type="text" placeholder=" Name" className="bg-[#89EC87] py-4 px-2 placeholder:text-black placeholder:font-light border border-black rounded-md shadow-lg" />
                <br />
                <input type="text" placeholder=" Phone No" className="bg-[#89EC87] py-4 px-2 placeholder:text-black placeholder:font-light border border-black rounded-md shadow-lg" />
                <br />
                <input type="text" placeholder=" Email Id" className="bg-[#89EC87] py-4 px-2 placeholder:text-black placeholder:font-light border border-black rounded-md shadow-lg" />
                <br />
                <input type="text" placeholder=" Message" className="bg-[#89EC87] py-4 px-2 placeholder:text-black placeholder:font-light border border-black rounded-md shadow-lg h-[150px]" />
