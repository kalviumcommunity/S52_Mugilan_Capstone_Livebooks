...
const BookShopHomepage = () => {
  const books = [
    { id: 1, title: "Zero to One", author: "Peter Thiel", price: 9.00, image: "/api/placeholder/200/300" },
    { id: 2, title: "Chronicles of Narnia", author: "C.S. Lewis", price: 18.00, image: "/api/placeholder/200/300" },
    { id: 3, title: "How Innovation Works", author: "Matt Ridley", price: 10.00, image: "/api/placeholder/200/300" },
    { id: 4, title: "Psychology of Money", author: "Morgan Housel", price: 12.00, image: "/api/placeholder/200/300" },
    { id: 5, title: "Atomic Habits", author: "James Clear", price: 11.99, image: "/api/placeholder/200/300" },
    { id: 6, title: "The Alchemist", author: "Paulo Coelho", price: 8.99, image: "/api/placeholder/200/300" },
  ];
        ...
        <section className="flex flex-col md:flex-row items-center mb-12">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            <div className="flex mt-6">
              {[...Array(5)].map((_, i) => (
                <img key={i} src="/api/placeholder/40/40" alt={User ${i+1}} className="w-10 h-10 rounded-full border-2 border-white -ml-2 first:ml-0" />
              ))}
          ...
          <div className="md:w-1/2">
            <img src="/api/placeholder/400/400" alt="Reader" className="w-full max-w-md mx-auto" />
          </div>
        </section>
